...
public class TaskController {
	...
	public ResponseEntity<List<TaskDto>> getTasks() {
		if (id == 0) {
			tasks = new ArrayList<>();
			tasks.add(new TaskDto(id++,"default title", "This is default task.", "20-05-2021", false,true));
		}
	...
	public ResponseEntity<TaskDto> addTask(@RequestBody TaskDto task) {
		...
		TaskDto newTask = new TaskDto(id++, task.getTitle(),task.getDescription(), task.getDueDate(), task.isReminder(),task.isComplete());
		tasks.add(newTask);
